...
class AlertStore with ChangeNotifier {
  Dio dio = Dio();
  ...
  Future<FetchModel<PvcModel>> getAlert() async {
    try {
      ...
      await dio
        ...
        debugPrint('Alert Store e1: ${error.toString()}');
      ...
      subject.error = ConfigStore().generalError;
      debugPrint('AlertStore e2: ${e.toString()}');
    } finally {
